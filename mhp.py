...
st.write("This app classifies test results into Normal, Inconclusive, or Abnormal using Logistic Regression.")

st.subheader("Enter Patient Information")

age = st.number_input("Age", min_value=0, max_value=120)
Convalescent = st.number_input("Convalescent", min_value=0, max_value=120)
...
expected_order = [
    'Age', 'Convalescent','Gender_Male', 'Blood Type_A-', 'Blood Type_AB+',
    ...
    'Medication_Ibuprofen', 'Medication_Lipitor', 
